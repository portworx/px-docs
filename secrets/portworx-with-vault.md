...
### Setting up Vault
Peruse [this section](https://www.vaultproject.io/docs/install/index.html) for help on setting up Vault in your setup. This includes installation, configuring secrets, etc
