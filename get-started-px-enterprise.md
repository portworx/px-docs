...
![Overview page in Portworx console](images/overview-updated.png "Overview page in Portworx console")
...
![Storage page in Portworx console](images/storage-actions-updated.png "Storage page in Portworx console")
