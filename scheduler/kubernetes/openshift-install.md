...
>*Openshift 3.9 and above:*<br/> Ensure that the worker nodes where you want Portworx installed have the `node-role.kubernetes.io/compute=true` label. This is required for the DaemonSet pods to run.
