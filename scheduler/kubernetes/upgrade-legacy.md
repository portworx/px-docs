...
>**IMPORTANT:**<br/> This method of upgrading portworx is DEPRECATED.  If you are running Portworx as Docker containers, we highly reccomend to migrate it into the OCI containers by following the [upgrade instructions](/scheduler/kubernetes/upgrade.html#docker-to-oci).
