...
```
curl -fsL http://install.portworx.com/1.3.0/upgrade | bash -s 
```
...
```
curl -fsL http://install.portworx.com/1.3.0/upgrade | bash -s -- -t 1.3.0-rc5
```
...
For example:
```
curl -fsL http://install.portworx.com/1.3.0/upgrade | bash -s -- --scaledownsharedapps off
```
