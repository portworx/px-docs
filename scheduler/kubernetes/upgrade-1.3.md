...
```
curl -fsL https://install.portworx.com/1.3.0/upgrade | bash -s 
```
...
```
curl -fsL https://install.portworx.com/1.3.1/upgrade | bash -s -- -t 1.3.1.1
```
...
For example:
```
curl -fsL https://install.portworx.com/1.3.0/upgrade | bash -s -- --scaledownsharedapps off
```
